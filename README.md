...
- [Test App-Server Commands](https://github.com/sheakimran/AWS_Three_Tier_Web/blob/main/app-server-commands)
- Create AMI.
...
- [Test Web-Server Commands](https://github.com/sheakimran/AWS_Three_Tier_Web/blob/main/web-server-commands)
- Create AMI.
- Create launch template using AMI.
- Create target group.
